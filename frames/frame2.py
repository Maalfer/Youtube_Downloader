...
from .lib_download import descargarPlaylistVideo, calidades_video_posibles
...
class Frame2:
    ...
    def __init__(self,
        ...
        self.EqtiquetaInformacion1 = Label(self.Frame, text=self.InstanciaPadre.idiomas.info2)
        ...
        self.EqtiquetaInformacion4.place(relx=0.1, rely=0.75)
        ...
        self.comb.place(relx=0.6, rely=0.75, relwidth=0.2)
